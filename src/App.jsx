...
const EQUIPMENT = [
  ...
  { id: "hotpress-old", name: "Hot Press Machine HC300-15-1 old", cat: "Processing" },
  { id: "hotpress-new", name: "Hot Press Machine HC300-15-2 new", cat: "Processing" },
  { id: "freeze-dryer", name: "Freeze Dryer FMD1010-1 left", cat: "Processing" },
  { id: "freeze-dryer", name: "Freeze Dryer FMD1010-2 right", cat: "Processing" },
  ...
  { id: "minimixer", name: "Mini Mixer MS-1N 1", cat: "Processing" },
  { id: "minimixer", name: "Mini Mixer MS-1N 2", cat: "Processing" },
  ...
  { id: "ultrasonic", name: "Ultrasonicator As one 1", cat: "Processing" },
  { id: "ultrasonic", name: "Ultrasonicator As one 2", cat: "Processing" },
];

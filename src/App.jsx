...
const EQUIPMENT = [
  ...
  { id: "contrast-micro", name: "Contrast Microscopy KEYENCE VH-Z500", cat: "Structural/Morphological Analysis" },
  ...
  { id: "gpc", name: "GPC HLC-8320", cat: "Molecular/Chemical Analysis" },
  { id: "gcms", name: "GCMS-QP2010", cat: "Molecular/Chemical Analysis" },
  { id: "titrator", name: "KEM Potentiometric Titrator AT-710", cat: "Molecular/Chemical Analysis" },
  { id: "contact-angle", name: "Contact Angle Measurement DMs-401", cat: "Surface Properties" },
  { id: "hotpress-old1", name: "Hot Press Machine HC300-15-1 old", cat: "Processing" },
  { id: "hotpress-new2", name: "Hot Press Machine HC300-15-2 new", cat: "Processing" },
  { id: "freeze-dryer1", name: "Freeze Dryer FMD1010-1 left", cat: "Processing" },
  { id: "freeze-dryer2", name: "Freeze Dryer FMD1010-2 right", cat: "Processing" },
  { id: "autoclave", name: "Autoclave Tomy LBS-325", cat: "Processing" },
  { id: "oilbath-1", name: "Oil Bath 1 with condenser", cat: "Processing" },
  { id: "oilbath-2", name: "Oil Bath 2", cat: "Processing" },
  ...
  { id: "minimixer1", name: "Mini Mixer MS-1N 1", cat: "Processing" },
  { id: "minimixer2", name: "Mini Mixer MS-1N 2", cat: "Processing" },
  ...
  { id: "ultrasonic1", name: "Ultrasonicator As one 1", cat: "Processing" },
  { id: "ultrasonic2", name: "Ultrasonicator As one 2", cat: "Processing" },
];
